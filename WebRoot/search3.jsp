...
<html>
  ...
  <tr><td>
   <font size="4">
   Java is a   <hai> <a href="./Planguage.jsp"><b>programming language</b> </a> </hai>originally developed by <hai><a href="./JamesGosling.jsp"><b>James Gosling at Sun Microsystems </b></a></hai>(which is now a subsidiary of Oracle Corporation) and released in 1995 as a core component of Sun Microsystems' Java platform. The language derives much of its syntax from  <hai><a href="./C.jsp"> <b>C </b></a> </hai>and  <hai><a href="./Cpp.jsp"> <b>C++</b></a> </hai> but has a simpler object model and fewer low-level facilities. Java applications are typically compiled to bytecode (class file) that can run on any <hai> <a href="./JVM.jsp"><b>Java Virtual Machine (JVM)</b> </a> </hai>regardless of computer architecture. Java is a general-purpose, concurrent, class-based,
    <hai><a href="./Oops.jsp"> <b>object-oriented language</b></a> </hai> that is specifically designed to have as few implementation dependencies as possible. It is intended to let application developers "write once, run anywhere." Java is currently one of the most popular programming languages in use, particularly for <hai><a href="./Clientserver.jsp"> <b> client-server web applications</b></a> </hai>.
</font>
</td></tr>
<tr><td>
Versions</td></tr>
...
The heart of the Java platform is the concept of a Java Virtual Machine (JVM)  that executes Java bytecode programs. This bytecode is the same no matter what hardware or operating system the program is running under. There is a JIT(Just In Time) compiler within the Java Virtual Machine (JVM) or JVM. The JIT compiler translates the Java bytecode into native processor instructions at run-time and caches the native code in memory during execution.

The use of bytecode as an intermediate  programming language  permits Java programs to run on any platform that has a virtual machine available. The use of a JIT compiler means that Java applications, after a short delay during loading and once they have "warmed up" by being all or mostly JIT-compiled, tend to run about as fast as native programs.[citation needed] Since <hai><a href="./jre.jsp"><b>Java Runtime Environment</b></a> </hai> version 1.2, Sun's JVM implementation has included a just-in-time compiler instead of an interpreter.

Although Java programs are cross-platform or platform independent, the code of the Java Virtual Machine (JVM)   that execute these <hai> <a href="./Program.jsp"><b>programs</b></a></hai> is not. Every supported operating platform has its own JVM.
  ...
  <tr>
   <td>
   An instruction set, or instruction set architecture (ISA), is the part of the computer architecture related to programming, including the native data types, instructions, registers, addressing modes, memory architecture, interrupt and <hai><a href="./Exception.jsp"><b>exception handling</b></a> </hai>, and external I/O.
    An ISA includes a specification of the set of opcodes (machine language), and the native commands implemented by a particular processor.
     ...
     Instruction set architecture is distinguished from the microarchitecture, which is the set of processor design techniques used to implement the instruction set. <hai><a href="./Computer.jsp"> <b>computer</b></a> </hai> with different microarchitectures can share a common instruction set. 
     ...
     In computer science, <hai><a href="./Functional.jsp"> <b>functional programming</b></a> </hai> is a programming paradigm that treats computation
     ...
     which emphasizes changes in state.  functional programming has its roots in lambda calculus, 
...
The first person team was interested in building highly interactive devices, and when Time Warner issued a request for proposal (RFP) for a set-top box, firstperson changed their target and responded with a proposal for a set-top box platform. However, the cable industry felt that their platform gave too much control to the user and firstperson lost their bid to SGI. An additional deal with The 3DO Company for a set-top box also failed to materialize. Unable to generate interest within the TV industry, the company was rolled back into Sun.
   ...
   A Java Virtual Machine is a piece of software that is implemented on non-virtual hardware and on standard operating systems. A Java Virtual Machine (JVM)  provides an environment in which Java bytecode can be executed, enabling such features as automated  exception handling, which provides "root-cause" debugging information for every software error (exception), independent of the source code. A Java Virtual Machine (JVM)  is distributed along with a set of standard class libraries that implement the Java application programming interface (API). Appropriate APIs bundled together form the  Java Runtime Environment (JRE).
   </td></tr>
    ...
    A programming language is an artificial language designed to communicate <hai> <a href="./instruction.jsp"> <b>instructions</b></a></hai> to a machine, 
    particularly a  computer. Programming languages can be used to create programs that control the behavior of a machine and/or to express  <hai><a href="./Algorithm.jsp"><b>algorithms</b></a> </hai> precisely.
    
    </td>
    </tr>
    <tr><td>
    
    The earliest programming languages predate the invention of the computer, and were used to direct the behavior of machines such as Jacquard looms and player pianos. Thousands of different programming languages have been created, mainly in the computer field, with many more being created every year. Most programming languages describe computation in an imperative style, i.e., as a sequence of commands, although some languages, such as those that support  functional programming or  <hai><a href="./LogicProgram.jsp"><b>logical programming</b></a> </hai>, use alternative forms of description.
   ...
   <br/>
   <br/>
   <a href="./GetLinksAction1?page=search3.jsp">Check the of Citetions</a>
   <br/>
